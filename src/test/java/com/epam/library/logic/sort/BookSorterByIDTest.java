...
public class BookSorterByIDTest {

    private final BookSorter sorter = new BookSorterByID();
    ...
    @Test
    public void sortAscendingTestShouldReturnListOfBooksSortedAscendingByID() {
        //given
        //when
    ...
    @Test
    public void sortDescendingTestShouldReturnListOfBooksSortedDescendingByID() {
        //given
        //when
